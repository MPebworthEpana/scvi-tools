...
from scvi.data.fields._atac_token_field import MuDataAtacTokenField
...
from scvi.module import MAMBAVAE, MULTIVAE
...
class MAMBAVI(
    ...
    **model_kwargs
    ...
    _module_cls = MAMBAVAE
    _data_splitter_cls = MambaDataSplitter
    _data_loader_cls = MambaAnnDataLoader
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        if coord_table is None and n_regions and n_regions > 0:
            modalities = self.adata_manager.registry.get("setup_args", {}).get("modalities", {})
            atac_mod = modalities.get("atac_layer")
            if atac_mod is not None and isinstance(adata, MuData):
                coord_table = build_coord_table(list(adata[atac_mod].var_names))
        ...
        self.module = self._module_cls(
            ...
            atac_genomic_sort=atac_genomic_sort,
            mamba_d_model=mamba_d_model,
            mamba_n_layers=mamba_n_layers,
            mamba_use_checkpoint=mamba_use_checkpoint,
