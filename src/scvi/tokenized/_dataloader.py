"""AnnDataLoader that uses SetAnnTorchDataset for CSR token streaming."""
...
class SetAnnDataLoader(AnnDataLoader):
    """Data loader that streams ATAC tokens from CSR rows."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dataset = adata_manager.create_set_torch_dataset(
            indices=indices,
